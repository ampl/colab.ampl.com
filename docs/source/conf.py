...
project = "AMPL Model Colaboratory"
...
latex_documents = [
    ("index", "amplcolab.tex", "AMPL Model Colaboratory", "Filipe Brandão", "manual"),
]
...
man_pages = [("index", "AMPL Colab", "AMPL Model Colaboratory", ["Filipe Brandão"], 1)]

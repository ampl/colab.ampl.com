...
| |github-battery-energy-storage-system-bess-evaluation-model| |colab-battery-energy-storage-system-bess-evaluation-model| |deepnote-battery-energy-storage-system-bess-evaluation-model| |kaggle-battery-energy-storage-system-bess-evaluation-model| |gradient-battery-energy-storage-system-bess-evaluation-model| |sagemaker-battery-energy-storage-system-bess-evaluation-model|
...
| Tags: :ref:`tag-energy`, :ref:`tag-electric-power-industry`, :ref:`tag-bess`, :ref:`tag-battery-energy-storage-system`, :ref:`tag-power-generation`, :ref:`tag-amplpy`
| Author: :ref:`email-tom_at_ampl.com` <tom@ampl.com>, :ref:`email-juan_at_ampl.com` <juan@ampl.com>, :ref:`email-mikhail_at_ampl.com` <mikhail@ampl.com>

.. |github-battery-energy-storage-system-bess-evaluation-model|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: bess.ipynb
    
.. |colab-battery-energy-storage-system-bess-evaluation-model| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: Open In Colab
    
.. |deepnote-battery-energy-storage-system-bess-evaluation-model| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-battery-energy-storage-system-bess-evaluation-model| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: Open In Kaggle
    
.. |gradient-battery-energy-storage-system-bess-evaluation-model| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: Open In Gradient
    
.. |sagemaker-battery-energy-storage-system-bess-evaluation-model| image:: https://studiolab.sagemaker.aws/studiolab.svg
    :target: https://studiolab.sagemaker.aws/import/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/bess/bess.ipynb
    :alt: Open In SageMaker Studio Lab
...
.. |github-bilevel-markets|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: bilevel_markets.ipynb
    
.. |colab-bilevel-markets| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: Open In Colab
    
.. |deepnote-bilevel-markets| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-bilevel-markets| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: Open In Kaggle
    
.. |gradient-bilevel-markets| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: Open In Gradient
    
.. |sagemaker-bilevel-markets| image:: https://studiolab.sagemaker.aws/studiolab.svg
    :target: https://studiolab.sagemaker.aws/import/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/bilevel/bilevel_markets.ipynb
    :alt: Open In SageMaker Studio Lab
...
^^^^^^^^^^^^^^^^^^^^^^^^^^
| `Notebooks <notebooks/index.html>`_ > `MineLib in AMPL and amplpy <notebooks/minelib-in-ampl-and-amplpy.html>`_
| |github-minelib-in-ampl-and-amplpy| |colab-minelib-in-ampl-and-amplpy| |deepnote-minelib-in-ampl-and-amplpy| |kaggle-minelib-in-ampl-and-amplpy| |gradient-minelib-in-ampl-and-amplpy| |sagemaker-minelib-in-ampl-and-amplpy|
...
| Tags: :ref:`tag-educational`, :ref:`tag-mining`, :ref:`tag-amplpy`, :ref:`tag-gurobi`, :ref:`tag-minelib`
| Author: :ref:`email-eduardo_at_ampl.com` <eduardo@ampl.com>

.. |github-minelib-in-ampl-and-amplpy|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/minelib/MineLib_AMPL.ipynb
    :alt: MineLib_AMPL.ipynb
    
.. |colab-minelib-in-ampl-and-amplpy| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/minelib/MineLib_AMPL.ipynb
    :alt: Open In Colab
    
.. |deepnote-minelib-in-ampl-and-amplpy| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/minelib/MineLib_AMPL.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-minelib-in-ampl-and-amplpy| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/minelib/MineLib_AMPL.ipynb
    :alt: Open In Kaggle
    
.. |gradient-minelib-in-ampl-and-amplpy| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/minelib/MineLib_AMPL.ipynb
    :alt: Open In Gradient
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
| `Notebooks <notebooks/index.html>`_ > `Refinery production and shadow pricing <notebooks/refinery-production-and-shadow-pricing.html>`_
| |github-refinery-production-and-shadow-pricing| |colab-refinery-production-and-shadow-pricing| |deepnote-refinery-production-and-shadow-pricing| |kaggle-refinery-production-and-shadow-pricing| |gradient-refinery-production-and-shadow-pricing| |sagemaker-refinery-production-and-shadow-pricing|
...
| Tags: :ref:`tag-amplpy`, :ref:`tag-cbc`, :ref:`tag-finance`, :ref:`tag-refinery`, :ref:`tag-dual-values`, :ref:`tag-shadow-prices`
| Author: :ref:`email-marcos_at_ampl.com` <marcos@ampl.com>

.. |github-refinery-production-and-shadow-pricing|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: refinery-production.ipynb
    
.. |colab-refinery-production-and-shadow-pricing| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: Open In Colab
    
.. |deepnote-refinery-production-and-shadow-pricing| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-refinery-production-and-shadow-pricing| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: Open In Kaggle
    
.. |gradient-refinery-production-and-shadow-pricing| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: Open In Gradient
    
.. |sagemaker-refinery-production-and-shadow-pricing| image:: https://studiolab.sagemaker.aws/studiolab.svg
    :target: https://studiolab.sagemaker.aws/import/github/ampl/colab.ampl.com/blob/master/authors/marcos-dv/educational/refinery-production.ipynb
    :alt: Open In SageMaker Studio Lab
...
.. |github-unit-commitment-for-colombias-energy-market|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: unit_commitment_colombia.ipynb
    
.. |colab-unit-commitment-for-colombias-energy-market| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: Open In Colab
    
.. |deepnote-unit-commitment-for-colombias-energy-market| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-unit-commitment-for-colombias-energy-market| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: Open In Kaggle
    
.. |gradient-unit-commitment-for-colombias-energy-market| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: Open In Gradient
    
.. |sagemaker-unit-commitment-for-colombias-energy-market| image:: https://studiolab.sagemaker.aws/studiolab.svg
    :target: https://studiolab.sagemaker.aws/import/github/ampl/colab.ampl.com/blob/master/authors/jpbohorquez/uc-colombia/unit_commitment_colombia.ipynb
    :alt: Open In SageMaker Studio Lab

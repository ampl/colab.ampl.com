...
Book Example: diet
^^^^^^^^^^^^^^^^^^
Description: Book Example: diet (autogenerated using diet.mod, diet.dat, and diet.run)
...
Book Example: econ
^^^^^^^^^^^^^^^^^^
Description: Book Example: econ (autogenerated using econ.mod, econ.dat, and econ.run)
...
^^^^^^^^^^^^^^^^^^^^^^
Description: Book Example: multmip1 (autogenerated using multmip1.mod, multmip1.dat, and multmip1.run)
...
Book Example: net1
^^^^^^^^^^^^^^^^^^
Description: Book Example: net1 (autogenerated using net1.mod, net1.dat, and net1.run)
...
^^^^^^^^^^^^^^^^^^^^^
Description: Book Example: nltrans (autogenerated using nltransd.mod, nltrans.dat, and nltrans.run)
...
Book Example: prod
^^^^^^^^^^^^^^^^^^
Description: Book Example: prod (autogenerated using prod.mod, prod.dat, and prod.run)
...
Book Example: steel
^^^^^^^^^^^^^^^^^^^
Description: Book Example: steel (autogenerated using steel.mod, steel.dat, and steel.run)
...
Book Example: transp
^^^^^^^^^^^^^^^^^^^^
Description: Book Example: transp (autogenerated using transp.mod, transp.dat, and transp.run)
